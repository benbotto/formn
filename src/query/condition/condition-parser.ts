 ...
 * takes in a set of tokens, as generated by the ConditionLexer.parse method,
 * and makes sure that the condition is valid.  If the condition sentence does
 * not match the condition grammer, an exception is raised.  Otherwise, a parse
 * tree is created.
 */
export class ConditionParser {
  /**
   * Parse the tokens return a parse tree.  The condition must follow the
   * following grammar.
   *
   * <pre>
